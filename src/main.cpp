          ...
          // j[1] is the data JSON object
            ...
            for (int i = 0; i < sensor_fusion.size(); i++) {
              ...
              if (car_lane == lane) {
                ...
                car_left |= check_car_s > car_s - 20 && check_car_s < car_s + 45;
              }
              else if (car_lane - lane == 1) {
              ...
              //try to avoid the sudden lane change of another car from two-lane away
                ...
                car_right |= check_car_s > car_s - 10 && check_car_s < car_s + 30;
              }
            }
            ...
            if (car_front) {
              if (lane > 0 && !car_left) { //left lane change
                ...
                too_close = true;
                acc = (prev_car_front_dist > car_front_dist) ? .224 * (1 - car_front_dist / 90.0) : 0.0; //smooth acceleration
                prev_car_front_dist = car_front_dist;
              }
            }
            else {
            ...
            //transform into car's coordinates (like in MPC)
            ...
            //future path
            //start with all of the previous path points from last time, points not eaten up by the car last time
            //instead of recreating the path from scratch every single time, just add points onto it 
            for (int i = 0; i < previous_path_x.size(); i++) {
              next_x_vals.push_back(previous_path_x[i]);
              next_y_vals.push_back(previous_path_y[i]);
            }

            //calculate how to break up spline points so that we travel at our desired reference velocity (35:00)
            ...
            for (int i = 1; i <= 50 - previous_path_x.size(); i++) {
              ...
              //go back to the global coordinates
